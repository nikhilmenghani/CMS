...
INSERT INTO `class_dept_master` VALUES (1,3,1),(2,3,2),(3,3,3),(4,3,4),(5,5,3),(6,5,4);
...
INSERT INTO `student_master` VALUES (1,'100130116012','Nikhil Menghani','1990-02-25','fshfghr','1234567897','n','n','3','2010','7','M','General','0','Regular','6121','GSEB','A+','1234567898',NULL,NULL,'0','0','A','CE-A1','',''),(3,'100130116011','Rishubh','1993-07-18','ahmedabad','1234567897','r','r','4','2010','3','M','General','0','Regular','6121','GSEB','A+','1234567898',NULL,NULL,'0','0','N/A','IT-1','',''),(4,'100130111028','Samkit Jain','1992-07-10','sabarmati','8460048983','s','s','1','2010','7','M','General','0','Regular','6000','GSEB','O+','8460048983',NULL,NULL,'0','0','A','EC-A1','',''),(5,'100130116027','Yogesh Sharma','1992-12-22','No Idea','8866631719','y@y.y','y','3','2010','7','M','General','0','Regular','6000','GSEB','O+','8866631719',NULL,NULL,'0','0','N/A','IT-2','',''),(6,'100110011001','Niks','25-08-1993','Ahmedabad','8460048986','niks','p','3',NULL,'7','Male','General','0','Regular','6121','GSEB','A+','9016828817',NULL,NULL,'0','0','A','IT-1','',''),(7,'100130116029','Niks','25-08-1993','Ahmedabad','8460048986','rahul','q','3',NULL,'7','Male','General','0','','6121','GSEB','A+','9016828817',NULL,NULL,'0','0','A','IT-1','',''),(8,'100130116039','Niks','25-08-1993','Ahmedabad','8460048986','ankit','q','3','2010','7','Male','General','0','','6121','GSEB','A+','9016828817',NULL,NULL,'0','0','A','IT-1','',''),(9,'100130116010','Rutvij','1992-10-27','Baroda','1234567897','r@r.r','r','3','2010','7','M','General','0','Regular','','GSEB','A+','1234567898',NULL,NULL,'0','0','N/A','IT-1','',''),(10,'100130116026','Arpan','12/01/2013','Sabarmati','9722737495','a','a','3','2010','7','Male','General','0','Regular','12451','GSEB','A+','9909909909',NULL,NULL,'0','0','N/A','IT-2','','');
...
INSERT INTO `virtualclass_master` VALUES (1,'Java','Java is a programming language.',2,'YouTube','m3ER2s3Ytis',5),(2,'DLD','It stands for Digital Logic Design',2,'Nikhil','DWyX59I0kEs',3),(3,'Maths Limits and Derivatives','Maths Limits and Derivatives part 1 (Introduction to Calculus) CBSE class 11 Mathematics XI',2,'YouTube','jRxr30s-QBU',4),(4,'Lecture Modern Physics: Special Relativity (Stanford)','Lecture 1 of Leonard Susskinds Modern Physics course concentrating on Special Relativity. Recorded April 14, 2008 at Stanford University.',2,'YouTube','BAurgxtOdxY',1),(5,'Algorithms','Published under the Creative Commons Attribution-ShareAlike',2,'YouTube','gwlevtaC-u0',4);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getClassId`(clas_name varchar(100)) RETURNS int(11)
BEGIN
declare idd int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getDeptID`(dep_name VARCHAR(100)) RETURNS int(11)
BEGIN
declare dep_id int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getStaffId`(username varchar(100)) RETURNS int(11)
BEGIN
declare idd int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getStudentId`(mail_id varchar(100)) RETURNS int(11)
BEGIN
declare idd int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `isStaffRegistered`(mail_id varchar(100)) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `isStudentRegisteredWithEmailId`(mail_id varchar(100)) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddClass`(in title varchar(100), in description varchar (10000), in username varchar(50), in courtesy varchar(50), in kkey varchar(50), in associatedsem varchar(11))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AddDeptToClass` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddDeptToClass`(in class_title varchar(100), dept_name varchar(100))
BEGIN
set @classidd = getClassId(class_title);
set @deptidd = getDeptID(dept_name);
INSERT INTO `cms`.`class_dept_master` (`class_id`, `dept_id`) VALUES (@classidd, @deptidd);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
Set @dept_idd = getDeptID(department);
...
-- Dump completed on 2013-12-25 19:40:00
