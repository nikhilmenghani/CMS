...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `AddClass`(in title varchar(50), in description varchar (10000), in username varchar(50), in courtesy varchar(50), in kkey varchar(50))
BEGIN
set @idd = getStaffId(username);
INSERT INTO `cms`.`virtualclass_master` (`title`, `description`, `staff_id`, `courtesy`, `key`) VALUES (title, description, @idd, courtesy, kkey);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `AddVideo`(in title varchar(50), in class_name varchar(50), in kkey varchar(50), in description varchar(10000))
BEGIN
set @idd = getClassId(class_name);
insert into `cms`.`video_master` (`title`, `class_id`, `key`, `description`, `thumbnail_path`) values (title, @idd, kkey, description, 'thumbnail.jpg');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2013-12-15 17:40:57
