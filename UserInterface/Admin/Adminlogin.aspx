<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="CMS.UserInterface.Admin.adminlogin" %>
...
<head>
    ...
    <!-- The styles -->
    <link id="bs-css" href="../Common/css/bootstrap-redy.css" rel="stylesheet" />
    <style type="text/css">
        body
        {
            padding-bottom: 40px;
        ...
        <div class="row-fluid">
            <div class="row-fluid">
                <div class="span12 center login-header">
                    <h2 align="center">Content Management System, GECG</h2>
            ...
            <div class="row-fluid">
                <div class="well span5 center login-box">
                    ...
                    <form id="Form1" class="form-horizontal" runat="server" action="" method="post">
                        <fieldset>
                            ...
                            <div class="input-prepend" title="Username" data-rel="tooltip">
                                ...
                                <asp:TextBox runat="server" autofocus class="input-large span10" name="username"
                                    ID="username" type="text" Enabled="true" value="n" placeholder="Username"></asp:TextBox>
                            </div>
                            <div class="clearfix">
                            </div>
                            <div class="input-prepend" title="Password" data-rel="tooltip">
                                <span class="add-on"><i class="icon-lock"></i></span>
                                <asp:TextBox class="input-large span10" name="password" ID="pwd" Enabled="true"
